/*PRIMS ALGORITHM 
https://practice.geeksforgeeks.org/problems/minimum-spanning-tree/1/?page=1&difficulty[]=1&status[]=solved&category[]=Graph&sortBy=submissions
*/
class Solution
{
	public:
	//Function to find sum of weights of edges of the Minimum Spanning Tree.
    	int primsAlgo(int s,int V,vector<vector<int>> adj[]){
	    int key[V];
        bool mst[V];
